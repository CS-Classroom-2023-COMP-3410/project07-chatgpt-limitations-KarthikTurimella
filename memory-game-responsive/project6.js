document.addEventListener("DOMContentLoaded", () => {
  ...
  // Fruit border generation for animations
  ...
  function generateFruitBorder() {
      fruitBorderContainer.innerHTML = ""; // Clear existing fruits
  ...
  generateFruitBorder(); // Call to generate fruits on initial load
  window.addEventListener("resize", generateFruitBorder); // Re-generate fruits on resize
});
